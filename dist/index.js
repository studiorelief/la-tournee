...
(() => {
  ...
  var ScrollTrigger2 = /* @__PURE__ */ function() {
    ...
    ScrollTrigger3.isInViewport = function isInViewport2(element, ratio, horizontal) {
  ...
  function stepAnim() {
    gsapWithCSS.set(".comment_number-w", {
      opacity: 0,
      y: -32
    });
    gsapWithCSS.to(".comment_number-w", {
      opacity: 1,
      y: 0,
      stagger: 0.5,
      // Effet de "stagger"
      scrollTrigger: {
        markers: false,
        trigger: ".section_comment",
        // Déclencheur de l'animation
        start: "top 60%",
        // Début de l'animation lorsque le haut du déclencheur atteint 75% du viewport
        end: "bottom 85%",
        // Fin de l'animation lorsque le bas du déclencheur atteint 25% du viewport
        scrub: true
        // Lisse l'animation
      }
    });
  ...
  // src/utils/homeVideo.ts
  init_live_reload();
  var isInViewport = (element) => {
    const rect = element.getBoundingClientRect();
    return rect.top <= (window.innerHeight || document.documentElement.clientHeight) && rect.left <= (window.innerWidth || document.documentElement.clientWidth);
  };
  function pauseVideo() {
  ...
  function tradDate() {
    ...
    (0, import_jquery.default)(".is-month").each(function() {
      const monthNum = parseInt((0, import_jquery.default)(this).text(), 10) - 1;
