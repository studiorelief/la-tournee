...
(() => {
      ...
      (function(global, factory) {
        ...
        jQuery.fn.extend({
          find: function(selector3) {
            ...
            ret = this.pushStack([]);
            for (i2 = 0; i2 < len; i2++) {
              jQuery.find(selector3, self[i2], ret);
            }
        ...
        jQuery.fn.load = function(url, params, callback) {
          var selector3, type, response, self = this, off = url.indexOf(" ");
          if (off > -1) {
  ...
  function startCountUpAnimation() {
    const container = document.querySelector("#is-countup");
    ...
    const countUp = new i(container, number, {
      startVal: 1e5,
      duration: 3,
      decimalPlaces: 0,
      separator: ""
  ...
  function initializeCountUpAndStyle() {
    const container = document.querySelector("#is-countup");
    if (!container) {
  ...
  function formAnim() {
    gsapWithCSS.set(".a--form-1", {
      opacity: 0.5
    });
    gsapWithCSS.set(".a--form-2", {
      opacity: 1
    });
    gsapWithCSS.set(".form-cp_image.is-right", {
      rotate: 25
    });
    gsapWithCSS.set(".form-cp_image.is-left", {
      rotate: 10
    });
    gsapWithCSS.to(".a--form-1", {
      opacity: 1,
      stagger: 0,
      repeat: -1,
      duration: 0.5
    });
    gsapWithCSS.to(".a--form-2", {
      delay: 0.5,
      opacity: 0.5,
      stagger: 0,
      repeat: -1,
    ...
    gsapWithCSS.to(".form-cp_image.is-right", {
      rotate: 60,
      stagger: 0,
      duration: 1.5,
      yoyo: true,
    ...
    gsapWithCSS.to(".form-cp_image.is-left", {
      rotate: -30,
      stagger: 0,
      duration: 1.5,
      yoyo: true,
  ...
  async function checkPostalCode() {
    ...
    try {
      ...
      if (found) {
        document.querySelector(".home-hero_form-success").style.display = "flex";
        document.querySelector(".home-hero_form-not-success").style.display = "none";
      } else {
        document.querySelector(".home-hero_form-not-success").style.display = "flex";
        document.querySelector(".home-hero_form-success").style.display = "none";
      }
    } catch (error) {
  ...
  function closeNav() {
    (0, import_jquery.default)(".navbar_menu-bg").on("click", function() {
      (0, import_jquery.default)(".navbar_menu").trigger("click");
    });
  }
  function inputSync(inputDuplicateSelector, inputSelector, submitDuplicateSelector, submitSelector) {
    (0, import_jquery.default)(inputDuplicateSelector).on("input", function() {
      ...
      if (value !== void 0) {
        ...
        (0, import_jquery.default)("#cp-popup").val(value);
      }
    });
    (0, import_jquery.default)(inputSelector).on("input", function() {
      const value = (0, import_jquery.default)(this).val();
      if (value !== void 0) {
        (0, import_jquery.default)("#cp-popup").val(value);
      }
  ...
  function updateNavbarBasedOnScroll() {
    const scroll = (0, import_jquery.default)(window).scrollTop() || 0;
    if (scroll < 50) {
      (0, import_jquery.default)(".navbar_logo-circle").css("display", "block");
      (0, import_jquery.default)(".navbar_logo-scroll").css("display", "none");
      (0, import_jquery.default)(".navbar_menu-w").css({
        color: "#fef4ec",
        transition: "color 0.25s"
      });
      (0, import_jquery.default)(".navbar_background").css({
        transform: "translateY(-8rem)",
        transition: "transform 0.3s"
      });
      (0, import_jquery.default)(".navbar_brand-w").css({
        height: "3.25rem",
        transition: "height 0.5s"
      });
    } else {
      (0, import_jquery.default)(".navbar_logo-circle").css("display", "none");
      (0, import_jquery.default)(".navbar_logo-scroll").css("display", "block");
      (0, import_jquery.default)(".navbar_menu-w").css("color", "");
      (0, import_jquery.default)(".navbar_background").css("transform", "");
      (0, import_jquery.default)(".navbar_brand-w").css("height", "");
    }
  }
  function scrollNav() {
    (0, import_jquery.default)(window).scroll(updateNavbarBasedOnScroll);
  }
  ...
  function copyBlog() {
    ...
    if (button) {
      button.addEventListener("click", function() {
        ...
        alert("URL copi\xE9e dans le presse-papiers !");
      });
    } else {
    }
  }
  ...
  // src/utils/rangeSlider.ts
  init_live_reload();
  function rangeCalculator() {
    const fromInput = document.getElementById("From-1");
    const calculatorVariable = document.getElementById("calculator-variable");
  ...
  function observeRangeSliderChanges() {
    ...
    if (rangeSliderDisplay) {
      ...
      const config3 = { childList: true, characterData: true };
      observer.observe(rangeSliderDisplay, config3);
    } else {
  ...
  function updateBackgroundColor() {
    ...
    for (let i2 = 0; i2 <= 6; i2++) {
      const element = document.getElementById(`value-${i2}`);
      if (element) {
        element.style.backgroundColor = i2 <= inputValue ? "#ffffff" : "";
      }
    }
  }
  function observeColorChanges() {
    ...
    if (rangeSlider) {
      ...
      const config3 = { childList: true, characterData: true, subtree: true };
      observer.observe(rangeSlider, config3);
    } else {
      console.error("Range slider not found");
    }
  }
  ...
  // node_modules/.pnpm/swiper@10.2.0/node_modules/swiper/swiper.mjs
  init_live_reload();
  ...
  // node_modules/.pnpm/swiper@10.2.0/node_modules/swiper/modules/index.mjs
  init_live_reload();
  ...
  function reviewSwiper() {
    (0, import_jquery2.default)(".review_swiper-wrapper").each(function() {
      new Swiper((0, import_jquery2.default)(this).find(".swiper.is-review")[0], {
  ...
  function blogSwiper() {
    (0, import_jquery2.default)(".swiper-blog_swiper-wrapper").each(function() {
      new Swiper((0, import_jquery2.default)(this).find(".swiper.is-blog")[0], {
